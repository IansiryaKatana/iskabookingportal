      ...
      >
        <div className="relative w-full h-full flex flex-col">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="absolute top-4 right-4 z-50 rounded-md bg-black/50 hover:bg-black/70 text-white"
                ...
                {images.length > 1 && (
                  <>
                    <Button
                      variant="ghost"
                      size="icon"
                      className="absolute left-4 z-50 rounded-md bg-black/50 hover:bg-black/70 text-white"
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      className="absolute right-4 z-50 rounded-md bg-black/50 hover:bg-black/70 text-white"
                      onClick={goToNext}
                    >
