...
const Footer = () => {
  ...
  const footerCopyright = settings?.footer_copyright_text || `${settings?.company_name || "Urban Hub"}. All rights reserved.`;
    ...
    <footer style={{ backgroundColor: 'hsl(0 0% 0%)' }} className="text-white py-12 md:py-16">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          <div>
            <div className="mb-4">
              <img src={logoUrl} alt={settings?.company_name || "Urban Hub"} className="h-12" />
            </div>
