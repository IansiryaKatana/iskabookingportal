-- Fix get_payment_summary function to handle Pay in Full plans
-- For Pay in Full plans, calculate total from payment_plan_installments if contract_payment_schedule is empty
-- This handles cases where the payment schedule hasn't been generated yet
