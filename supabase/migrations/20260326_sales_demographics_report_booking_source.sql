-- Add booking_source to sales demographics report for export/reporting consumers.
-- Keep existing column order from current view and append booking_source at the end.
