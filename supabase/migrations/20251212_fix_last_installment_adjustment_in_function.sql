-- Fix get_payment_summary to apply last-installment adjustment
-- This aligns the database function with frontend logic (useStudentPayments.ts line 166)
-- Ensures total_due matches actual payments created with last-installment adjustment
--
-- Issue: Function calculates from percentages = £9,125.0874
-- But frontend creates payments with last-installment adjustment = £9,027.01
-- Difference causes remaining_balance = £98.0774 instead of £0.00
--
-- Fix: Apply same last-installment adjustment logic in database function
-- Last installment = Remaining Balance - Sum of Previous Installments
