-- Expand sales demographics reporting to include additional in-pipeline statuses
-- and expose the status as a selectable/filterable column for UI/export consumers.
...
WHERE sa.status IN ('confirmed', 'awaiting_deposit', 'awaiting_signature', 'awaiting_verification');
