-- Fix get_partner_referral_payment_summary - simpler version without exception handler
-- The 400 error might be caused by the exception handler or LATERAL join issues
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(ps.payment_status::TEXT, 'unpaid'::TEXT) AS payment_status,
