-- Fix get_installment_breakdown ambiguous column reference ("label") by qualifying
-- the column in CTEs. This replaces the previous function definition but keeps
