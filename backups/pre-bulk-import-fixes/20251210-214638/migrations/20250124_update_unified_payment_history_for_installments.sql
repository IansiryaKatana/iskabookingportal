-- Update unified_payment_history view to properly extract installment information
-- This ensures installment payments show with correct installment numbers and due dates
...
SELECT 
  ...
  -- Include metadata for accessing payment labels and other info
