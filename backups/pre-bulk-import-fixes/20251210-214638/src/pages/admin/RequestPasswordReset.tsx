            ...
            <div className="absolute bottom-0 right-0 text-right" style={{ paddingBottom: '50px', paddingRight: '50px' }}>
              ...
              <div className="max-w-lg ml-auto">
                <p className="text-[10px] md:text-[11px] leading-relaxed text-white/95">
                  Enter your staff email address to receive a password reset link. This will allow you to securely reset your admin account password and regain access to the dashboard.
                </p>
              </div>
            </div>
          </div>
